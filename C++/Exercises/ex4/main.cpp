...
/**
 * Given a binary file path and a _matrix,
 * reads the content of the file into the _matrix.
 * file must match _matrix in size in order to read successfully.
 * @param filePath - path of the binary file to read
 * @param mat -  _matrix to read the file into.
 ...
 *        path.
 * @param weights array of _matrix, weigths[i] is the i'th layer weights _matrix
 * @param biases array of _matrix, biases[i] is the i'th layer bias _matrix
